...
func (in *InlineFluxSource) DeepCopyInto(out *InlineFluxSource) {
	*out = *in
	if in.SourceRef != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InlineFluxSource.
func (in *InlineFluxSource) DeepCopy() *InlineFluxSource {
	if in == nil {
		return nil
	}
	out := new(InlineFluxSource)
	in.DeepCopyInto(out)
	return out
}
